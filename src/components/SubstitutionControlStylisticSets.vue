  ...
  <div class="substitutions-interface">
        ...
        <li
          ...
          <span
            ...
            class="substitution-button glyph-icon visualized-font">
              <span class="centered">{{substitution.default | unicode}}</span>
          </span>
        </li>
      </ul>
    ...
    <div class="substitution-control">
      ...
      <div
        ...
        <ul v-if="hasSearchResults" class="search-results-list">
          <li
      ...
      <div
        ...
        <div class="current-substitution-alternates">
          <GlyphAlternatesDisplay v-bind:glyph="currentSubstitution.default" v-bind:stylisticSets="stylisticSets" v-bind:previewBoxWidth="previewBoxWidth"/>
        </div>
        <DimensionControl
          dimensionName="x"
...
export default {
  ...
  components: {
    GlyphAlternatesDisplay, DimensionControl
  },
  methods: {
    ...mapMutations({
    ...
    selectGlyphAlternates (e, glyph) {
      console.log('Creating Substition from Selected Glyph')
      this.addNewSubstitution({glyph: glyph})
      this.results = []
    },
    goToSubstitution (e, index) {
      console.log('activate substitution')
      this.activateSubstitution({index: index})
    },
    newSubstitution () {
      this.activateSubstitution({index: -1})
      console.log('New Selection Pane')
    },
    getGlyphs (e) {
...
.substitutions-interface {
  ...
  .substitution-control {
    ...
    .search-results-list {
      height: 100%;
      max-height: calc(var(--substitution-selector-height));
      overflow-y: scroll;
    }
