...
Click to begin selecting (mouseover the grid to select), and click to end the selection. Then, command + click to pull up the substitution menu and select the alternate glyph.
...
- the outputs are not editable yet
